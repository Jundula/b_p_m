...
export default function Reviews(reviews) {
  ...
  // };
  return (
    <section className="group flex flex-col items-center overflow-hidden ">
      <h1 className="mb-4 text-xl md:text-4xl text-[#222449] font-Angkor  group-hover:text-red-600 transition-all duration-300 ease ">
        OPINIONES
      </h1>
      <h2 className="mb-16 text-lg md:text-2xl text-[#222449] font-Angkor  ">
      ...
      <div className="group flex  flex-col items-center relative bg-white p-4 w-full   ">
        ...
        >
          <div className=" bg-white p-4 w-full overflow-scroll scrollbar-hide">
            <div className="md:hover:-translate-x-[115vw] lg:hover:-translate-x-[75vw]  transition-all duration-[7000ms] linear flex flex-col items-center justify-center md:inline-flex md:flex-row  space-y-8 md:space-y-0  py-16 md:py-8 mt-4 bg-gray-50 md:px-[35vw] hover:translate-x-">
